...
* [Train MSR](model_preparation): Train the MSR network for adjusting segmentation stride.
* [Finetune Extractor](model_preparation): Fine-tune the original speaker embedding extractor with generated mixed data. 
